...
ax[1].plot(giorni[:], icu, color='tomato',label='Terapie intensive')
ax[1].plot(giorni[:], hospital, color='royalblue',label='Ricoverati')
ax[1].legend(loc='best')
ax[1].set_xlabel('Data')
ax[1].set_ylabel('Numero ospedalizzati')
ax[1].set_yscale('log')
