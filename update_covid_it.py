...
ax[1].plot(giorni[1:], 100*delta_icu/icu[1:], color='tomato',label='Terapie intensive')
ax[1].plot(giorni[1:], 100*delta_hospital/hospital[1:], color='royalblue',label='Ricoverati')
