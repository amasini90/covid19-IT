...
def load_data_local(where='Varese'):
    ...
    return [giorni,delta_casi,average]
...
giorni,ratio,average,perc_delta_hospital,perc_delta_icu = load_data_italy()

st.subheader('Percentuale di tamponi positivi')
...
giorni,delta_casi,average = load_data_local(where)
